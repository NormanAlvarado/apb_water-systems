    ...
    >
      ...
      >
        ...
        <div className="p-6 space-y-4">
          <p className="text-gray-600 text-center mb-6">How would you like to contact us?</p>
          
          {/* WhatsApp Option */}
          <button
            onClick={handleWhatsApp}
            className="w-full bg-green-600 hover:bg-green-700 text-white rounded-lg p-4 flex items-center justify-between transition-all group"
          >
          ...
          <button
            onClick={handleEmail}
            className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white rounded-lg p-4 flex items-center justify-between transition-all group"
          >
            <div className="flex items-center gap-3">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="pt-4 border-t border-gray-200">
            <p className="text-xs text-gray-500 text-center mb-2">Or call us directly</p>
            <a 
