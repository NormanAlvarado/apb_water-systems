        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-xl hover:shadow-2xl transition-shadow">
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-2">Authorized Distributor</h3>
                <p className="text-gray-600">
                  The only authorized distributor for RainSoft products in Costa Rica
                </p>
              </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-xl hover:shadow-2xl transition-shadow">
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-2">Advanced Filtration</h3>
                <p className="text-gray-600">
                  State-of-the-art technology removes impurities and contaminants for the purest water
                </p>
              </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-xl hover:shadow-2xl transition-shadow">
                ...
                <p className="text-gray-600">
                  Professional installation and ongoing support by certified technicians
                </p>
              </div>
          </div>
        </div>
